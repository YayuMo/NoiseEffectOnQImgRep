...
def constructAmplitudeDampingNoiseModel(param_meas, qb_nums, rand, instructions):
    # construct error
    ...
    if rand == True:
        ...
        noise_model.add_all_qubit_quantum_error(qerror_meas, instructions=instructions)
